...
<CaptionImage src={img3} alt="Interpretation of the SUS Score">
  <span slot="caption">Interpretation of the SUS Score. Image Source: <a href="https://www.uxables.com/investigacion-ux/medir-con-el-sistema-de-escala-de-usabilidad-sus/" class="underline hover:text-primary transition-colors">UXABLES</a></span>
</CaptionImage>
