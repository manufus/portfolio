...
<CaptionImage src={img0} alt="Snapshot of the original portfolio stack highlighting bad Lighthouse performance and accessibility issues.">
  <span slot="caption">Baseline before architecture hardening and UX engineering refactor. <a href="https://pagespeed.web.dev/analysis/https-manuelhortelano-com-about/8mlgosqpl8?form_factor=mobile" class="underline hover:text-primary transition-colors">Link to the Lighthouse report</a></span>
</CaptionImage>
